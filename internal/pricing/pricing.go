...
var models = map[string]Rate{
	...
	"mimo-v2.6-pro":              {Input: 0.435, Output: 0.87, Cached: 0.0036, Reasoning: 0.87, CacheWrite: 0.435},
	"mimo-v2.6-flash":            {Input: 0.14, Output: 0.28, Cached: 0.0028, Reasoning: 0.28, CacheWrite: 0.14},
	"mimo-v2.5-pro":              {Input: 0.435, Output: 0.87, Cached: 0.0036, Reasoning: 0.87, CacheWrite: 0.435},
	"mimo-v2.5":                  {Input: 0.14, Output: 0.28, Cached: 0.0028, Reasoning: 0.28, CacheWrite: 0.14},
	"mimo-v2-flash":              {Input: 0.14, Output: 0.28, Cached: 0.0028, Reasoning: 0.28, CacheWrite: 0.14},
	"minimax-m2.1":               {Input: 0.5, Output: 2.0, Cached: 0.25, Reasoning: 3.0, CacheWrite: 0.5},
...
var patterns = []struct {
	...
	{"mimo-v2.6-*", Rate{Input: 0.435, Output: 0.87, Cached: 0.0036, Reasoning: 0.87, CacheWrite: 0.435}},
	{"mimo-v2*", Rate{Input: 0.14, Output: 0.28, Cached: 0.0028, Reasoning: 0.28, CacheWrite: 0.14}},
	{"mimo-*", Rate{Input: 0.14, Output: 0.28, Cached: 0.0028, Reasoning: 0.28, CacheWrite: 0.14}},
